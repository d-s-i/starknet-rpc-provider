    ...
    getBlock(blockNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const tx of _block.transactions) {
                const _tx = yield this._populateTransaction({ transaction: tx });
    ...
    _populateTransaction(tx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tx.transaction.entry_point_selector) {
                tx.transaction.entry_point_type = "EXTERNAL";
                finalTransaction = Object.assign(Object.assign({}, tx), { type: "INVOKE_FUNCTION" });
            }
            else {
                if (tx.transaction.contract_address) {
                    ...
                    finalTransaction = Object.assign(Object.assign({}, tx), { type: "DEPLOY" });
                }
                else {
                    finalTransaction = Object.assign(Object.assign({}, tx), { type: "DECLARE" });
                }
            }
