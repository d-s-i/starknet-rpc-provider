...
class RPCProvider {
    ...
    getBlock(blockNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const block = yield this.request("starknet_getBlockByNumber", [_blockNumber, "FULL_TXN_AND_RECEIPTS"]);
            return block;
        });
    }
    ...
    getTransaction(txHash) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const transaction = yield this._populateTransaction({
    ...
    _populateTransaction(tx) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log("tx", tx);
            const contractClass = yield this.getClassAt(tx.transaction.contract_address);
            ...
            if (tx.transaction.entry_point_selector) {
                tx.transaction.entry_point_type = "EXTERNAL";
                return Object.assign(Object.assign({}, tx), { type: "INVOKE_FUNCTION" });
            }
            else {
                const contractClassHash = yield this.getClassHashAt(tx.transaction.contract_address);
                tx.transaction.class_hash = contractClassHash;
                return Object.assign(Object.assign({}, tx), { type: "DEPLOY" });
            }
        });
    }
    get baseUrl() {
